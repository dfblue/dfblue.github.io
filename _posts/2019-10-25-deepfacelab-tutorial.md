...
- deepfakes
highlight: true
excerpt: We will use DeepFaceLab to create the deepfakes. Another software, FaceSwap
...
* Run `2) extract images from video data_src`
  ...
  * FPS <= 10 that gets you _at least_ 2000 images (4k-6k is ideal)
...
* Run `4.2.other) data_src util add landmarks debug images`
  * New images with `_debug` suffix are created in  `data_src/aligned` which allow you to see the detected facial _landmarks_
